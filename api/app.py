...
def api_feed():
    ...
    try:
        ...
        official_feeds = {
            'all': rss_scanner.build_youtube_feed_url(channel_id, 'all'),
            'videos': rss_scanner.build_youtube_feed_url(channel_id, 'videos'),
            'shorts': rss_scanner.build_youtube_feed_url(channel_id, 'shorts'),
            'live': rss_scanner.build_youtube_feed_url(channel_id, 'live'),
            'selected': rss_scanner.build_youtube_feed_url(channel_id, feed_type),
        }
